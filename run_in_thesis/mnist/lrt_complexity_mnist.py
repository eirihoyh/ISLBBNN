...
second_ders = {}
for i in range(10):
    net = torch.load(f"network/lrt_class/net{i}_sigmoid", map_location=torch.device('cpu'))
...
np.save("complexity/lrt_class/second_der_mc", second_der_mc)
np.save("complexity/lrt_class/complexity_class", complexity_class)
np.save("complexity/lrt_class/complexity_tot", complexity_tot)
np.save("complexity/lrt_class/second_ders", second_ders)
