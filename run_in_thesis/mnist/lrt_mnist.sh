...
#SBATCH --job-name=l_mnist  # sensible name for the job
...
#SBATCH --output=/mnt/users/eirihoyh/mnist/log/mnist_lrt_low_prior_prob_%j.out
#SBATCH --error=/mnt/users/eirihoyh/mnist/log/mnist_lrt_low_prior_prob_%j.err
