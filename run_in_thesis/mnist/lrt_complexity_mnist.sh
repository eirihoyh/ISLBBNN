...
#SBATCH --job-name=l_m_complex  # sensible name for the job
...
#SBATCH --output=/mnt/users/eirihoyh/mnist/log/lrt_mnist_complexity_%j.out
#SBATCH --error=/mnt/users/eirihoyh/mnist/log/lrt_mnist_complexity_%j.err
...
python lrt_complexity_mnist.py
