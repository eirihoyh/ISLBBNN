...
#SBATCH --job-name=l_lin  # sensible name for the job
...
#SBATCH --output=/mnt/users/eirihoyh/linear_problem/log/lin_prob_lrt_%j.out
#SBATCH --error=/mnt/users/eirihoyh/linear_problem/log/lin_prob_lrt_%j.err
...
python lrt_early_stop_lin_func_class.py
