...
#SBATCH --job-name=l_lcomplex  # sensible name for the job
...
#SBATCH --output=/mnt/users/eirihoyh/linear_problem/log/lrt_complexity_%j.out
#SBATCH --error=/mnt/users/eirihoyh/linear_problem/log/lrt_complexity_%j.err
