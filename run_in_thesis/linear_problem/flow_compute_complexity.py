...
for d in dep_levels:
    ...
    complexity[f"dep: {d}"] = {}
    for i in range(10):
        net = torch.load(f"network/flow_class_high_sigma/net{i}_unif_{d}_dep", map_location=torch.device('cpu'))
        ...
        print(f"Done net {i}, dep {d}")

np.save("complexity/flow_class/complexity", complexity)
np.save("complexity/flow_class/second_der", second_der)
np.save("complexity/flow_class/first_der", first_der)

# print("START NON-LIN!!")
# #-------- y = x_1 + x_2 + x_1 x_2 + x_1^2 + x_2^2 + 100 -----------------
# first_der = {}
# second_der = {}
# complexity = {}
# for d in dep_levels:
...
# np.save("complexity/flow_class/early_stop_non_lin_func/complexity", complexity)
# np.save("complexity/flow_class/early_stop_non_lin_func/second_der", second_der)
# np.save("complexity/flow_class/early_stop_non_lin_func/first_der", first_der)
