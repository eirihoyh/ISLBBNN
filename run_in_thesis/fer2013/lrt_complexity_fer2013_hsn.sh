...
#SBATCH --job-name=l_hsn_complex  # sensible name for the job
...
#SBATCH --output=/mnt/users/eirihoyh/fer2013/log/lrt_fer_complexity_%j.out
#SBATCH --error=/mnt/users/eirihoyh/fer2013/log/lrt_fer_complexity_%j.err
...
python lrt_complexity_fer2013_hsn.py
