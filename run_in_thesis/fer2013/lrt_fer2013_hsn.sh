...
#SBATCH --job-name=l_fer_hsn  # sensible name for the job
...
#SBATCH --output=/mnt/users/eirihoyh/fer2013/log/fer2013_hsn_lrt_%j.out
#SBATCH --error=/mnt/users/eirihoyh/fer2013/log/fer2013_hsn_lrt_%j.err
