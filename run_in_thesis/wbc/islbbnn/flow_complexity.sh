...
#SBATCH --job-name=f_comp  # sensible name for the job
...
#SBATCH --output=/mnt/users/eirihoyh/wbc/islbbnn/log/wbc_flow_comp_%j.out
#SBATCH --error=/mnt/users/eirihoyh/wbc/islbbnn/log/wbc_flow_comp_%j.err
