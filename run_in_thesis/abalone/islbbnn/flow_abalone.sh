...
#SBATCH --job-name=f_abalone  # sensible name for the job
...
#SBATCH --output=/mnt/users/eirihoyh/abalone/islbbnn/log/abalone_flow_%j.out
#SBATCH --error=/mnt/users/eirihoyh/abalone/islbbnn/log/abalone_flow_%j.err
