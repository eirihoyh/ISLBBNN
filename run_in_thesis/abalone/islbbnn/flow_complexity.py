...
complexity_tot = {}
for i in range(10):
    net = torch.load(f"trained_nets/flow/net{i}", map_location=torch.device('cpu'))
...
np.save("complexity/flow/second_der_mc", second_der_mc)
np.save("complexity/flow/complexity_tot", complexity_tot)
np.save("complexity/flow/first_der_mc", first_der_mc)
