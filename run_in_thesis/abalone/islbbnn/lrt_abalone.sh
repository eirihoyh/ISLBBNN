...
#SBATCH --job-name=l_abalone  # sensible name for the job
...
#SBATCH --output=/mnt/users/eirihoyh/abalone/islbbnn/log/abalone_lrt_%j.out
#SBATCH --error=/mnt/users/eirihoyh/abalone/islbbnn/log/abalone_lrt_%j.err
