...
#SBATCH --job-name=f_compA  # sensible name for the job
...
#SBATCH --output=/mnt/users/eirihoyh/abalone/islbbnn/log/abalone_flow_comp_%j.out
#SBATCH --error=/mnt/users/eirihoyh/abalone/islbbnn/log/abalone_flow_comp_%j.err
