...
#SBATCH --job-name=l_nl  # sensible name for the job
...
#SBATCH --output=/mnt/users/eirihoyh/non_linear_problem/log/non_lin_lrt_%j.out
#SBATCH --error=/mnt/users/eirihoyh/non_linear_problem/log/non_lin_lrt_%j.err
...
python lrt_early_stop_non_lin_func_class.py
