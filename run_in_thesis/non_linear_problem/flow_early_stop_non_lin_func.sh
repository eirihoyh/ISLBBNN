...
#SBATCH --job-name=f_nl  # sensible name for the job
...
#SBATCH --output=/mnt/users/eirihoyh/non_linear_problem/log/non_lin_flow_%j.out
#SBATCH --error=/mnt/users/eirihoyh/non_linear_problem/log/non_lin_flow_%j.err
...
python flow_early_stop_non_lin_func_class.py
