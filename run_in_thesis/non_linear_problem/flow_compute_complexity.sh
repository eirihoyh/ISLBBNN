...
#SBATCH --job-name=f_nlcomplex  # sensible name for the job
...
#SBATCH --output=/mnt/users/eirihoyh/non_linear_problem/log/flow_complexity_%j.out
#SBATCH --error=/mnt/users/eirihoyh/non_linear_problem/log/flow_complexity_%j.err
