...
#SBATCH --job-name=f_mice  # sensible name for the job
...
#SBATCH --output=/mnt/users/eirihoyh/mice/log/mice_flow_%j.out
#SBATCH --error=/mnt/users/eirihoyh/mice/log/mice_flow_%j.err
